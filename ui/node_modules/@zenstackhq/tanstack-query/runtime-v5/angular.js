...
__export(angular_exports, {
  AngularQueryContextKey: () => AngularQueryContextKey,
  getHooksContext: () => getHooksContext,
  provideAngularQueryContext: () => provideAngularQueryContext,
...
var import_angular_query_v5 = require("@tanstack/angular-query-experimental");
...
function getHooksContext() {
  const context = (0, import_core.inject)(AngularQueryContextKey, {
    optional: true
  }) || {
  ...
  const _a = context, { endpoint } = _a, rest = __objRest(_a, ["endpoint"]);
...
function useModelMutation(model, method, url, modelMeta, options, fetch2, checkReadBack) {
  ...
  return (0, import_angular_query_v5.injectMutation)(() => finalOptions);
}
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  AngularQueryContextKey,
  getHooksContext,
