...
var chunk_PT6BQM56_exports = {};
__export(chunk_PT6BQM56_exports, {
  GetDmmfError: () => GetDmmfError,
  getDMMF: () => getDMMF
});
module.exports = __toCommonJS(chunk_PT6BQM56_exports);
  ...
  const dmmfPipeline = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        const data = import_chunk_UC6PZ63N.prismaSchemaWasm.get_dmmf(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
