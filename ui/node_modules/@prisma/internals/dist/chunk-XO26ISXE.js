...
var chunk_XO26ISXE_exports = {};
__export(chunk_XO26ISXE_exports, {
...
module.exports = __toCommonJS(chunk_XO26ISXE_exports);
...
[Context: getConfig]`;
    super((0, import_chunk_XOERJXRW.addVersionDetailsToErrorMessage)(errorMessageWithContext));
  ...
  const configEither = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        const data = import_chunk_UC6PZ63N.prismaSchemaWasm.get_config(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
