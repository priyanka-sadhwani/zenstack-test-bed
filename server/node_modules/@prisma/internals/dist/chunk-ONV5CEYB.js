...
var chunk_ONV5CEYB_exports = {};
__export(chunk_ONV5CEYB_exports, {
  GetDmmfError: () => GetDmmfError,
  getDMMF: () => getDMMF
});
module.exports = __toCommonJS(chunk_ONV5CEYB_exports);
  ...
  const dmmfPipeline = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        const data = import_chunk_JTIZ3F5J.prismaSchemaWasm.get_dmmf(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
