...
class ExpressionWriter {
    ...
    writeReference(expr) {
        if ((0, ast_1.isEnumField)(expr.target.ref)) {
            ...
            this.block(() => {
                ...
                (0, local_helpers_1.invariant)(ref);
    ...
    writeBaseHierarchy(thisModel, targetBase, conditionWriter) {
        ...
        this.writer.write(`${`${runtime_1.DELEGATE_AUX_RELATION_PREFIX}_${(0, local_helpers_1.lowerCaseFirst)(base.name)}`}: `);
        this.writer.block(() => {
    ...
    writeFieldReference(expr) {
        ...
        this.writer.write(`db.${(0, local_helpers_1.lowerCaseFirst)(containingModel.name)}.fields.${expr.target.ref.name}`);
    }
