...
const run = (model, options, _dmmf, globalOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (dmmf) {
        ...
        if (options.output || (globalOptions === null || globalOptions === void 0 ? void 0 : globalOptions.output)) {
            ...
            const prismaGenerator = (0, sdk_1.getPrismaClientGenerator)(model);
            const prismaClientPathAbs = path_1.default.resolve(outDir, (prismaGenerator === null || prismaGenerator === void 0 ? void 0 : prismaGenerator.isNewGenerator) ? 'client' : 'models');
