...
const is_wsl_1 = require("./utils/is-wsl");
const machine_id_utils_1 = require("./utils/machine-id-utils");
const version_utils_1 = require("./utils/version-utils");
const is_ci_1 = require("./utils/is-ci");
const is_container_1 = require("./utils/is-container");
/**
...
class Telemetry {
    constructor() {
        ...
        this.isWsl = (0, is_wsl_1.isWsl)();
        this.isContainer = (0, is_container_1.isInContainer)();
        this.isCi = is_ci_1.isInCi;
        this.exitWait = 200;
        ...
        (0, async_exit_hook_1.default)((callback) => __awaiter(this, void 0, void 0, function* () {
            if (this.mixpanel) {
                ...
                yield (0, local_helpers_1.sleep)(this.exitWait);
            }
            callback();
        }));
