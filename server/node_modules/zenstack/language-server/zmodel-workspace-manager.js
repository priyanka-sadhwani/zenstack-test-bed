        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const folder of _folders) {
                ...
                try {
                    ...
                    const languagePackageDir = path_1.default.dirname(languagePackagePath);
                    const candidateStdlibPath = path_1.default.join(languagePackageDir, 'res', constants_1.STD_LIB_MODULE_NAME);
                    // Check if the stdlib file exists in the installed package
                    if (fs_1.default.existsSync(candidateStdlibPath)) {
            ...
            if (installedStdlibPath) {
                ...
                stdLibPath = path_1.default.join(__dirname, '../res', constants_1.STD_LIB_MODULE_NAME);
                console.log(`Using bundled stdlib in extension`);
            }
            const stdLibUri = vscode_uri_1.URI.file(stdLibPath);
