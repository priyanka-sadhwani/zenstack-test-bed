...
import { CrudContract, DbClientContract, EnhancementContext, PolicyCrudKind, PolicyOperationKind } from '../../../types';
...
export declare class PolicyUtil extends QueryUtils {
    ...
    private singleKey;
    isTrue(condition: object | null | undefined): boolean;
    isFalse(condition: object | null | undefined): boolean;
    private makeTrue;
    private makeFalse;
    private reduce;
    ...
    private buildReadGuardForFields;
     ...
     */
    checkPolicyForUnique(model: string, uniqueFilter: any, operation: PolicyOperationKind, db: CrudContract, fieldsToUpdate: string[], preValue?: any): Promise<void>;
    ...
    private getCombinedFieldOverrideReadGuards;
     ...
     */
    getZodSchema(model: string, excludePasswordFields?: boolean, kind?: 'create' | 'update' | undefined): z.ZodType<any, z.ZodTypeDef, any> | undefined;
    /**
     ...
     */
    validateZodSchema(model: string, kind: 'create' | 'update' | undefined, data: object, excludePasswordFields: boolean, onError: (error: ZodError) => void): any;
    /**
