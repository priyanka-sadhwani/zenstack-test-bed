...
__export(react_exports, {
  ...
  useSuspenseInfiniteModelQuery: () => useSuspenseInfiniteModelQuery,
  useSuspenseModelQuery: () => useSuspenseModelQuery
});
...
function useModelQuery(model, url, args, options, fetch2) {
  ...
  return __spreadValues({
    queryKey
  }, (0, import_react_query_v5.useQuery)(__spreadValues({
    queryKey,
...
function useSuspenseModelQuery(model, url, args, options, fetch2) {
  ...
  return __spreadValues({
    queryKey
  }, (0, import_react_query_v5.useSuspenseQuery)(__spreadValues({
    queryKey,
    queryFn: ({ signal }) => fetcher(reqUrl, { signal }, fetch2, false)
  }, options)));
}
function useInfiniteModelQuery(model, url, args, options, fetch2) {
  ...
  return __spreadValues({
    queryKey
  }, (0, import_react_query_v5.useInfiniteQuery)(__spreadValues({
    queryKey,
...
function useSuspenseInfiniteModelQuery(model, url, args, options, fetch2) {
  ...
  return __spreadValues({
    queryKey
  }, (0, import_react_query_v5.useSuspenseInfiniteQuery)(__spreadValues({
    queryKey,
    queryFn: ({ pageParam, signal }) => {
      return fetcher(makeUrl(url, pageParam != null ? pageParam : args), { signal }, fetch2, false);
    },
