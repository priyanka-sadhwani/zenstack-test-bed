...
function useModelQuery(model, url, args, options, fetch2) {
  ...
  const result = (0, import_svelte_query.createQuery)(__spreadValues({
    queryKey,
...
function useInfiniteModelQuery(model, url, args, options, fetch2) {
  ...
  const result = (0, import_svelte_query.createInfiniteQuery)(__spreadValues({
    queryKey,
    queryFn: ({ pageParam, signal }) => fetcher(makeUrl(url, pageParam != null ? pageParam : args), { signal }, fetch2, false)
  }, options));
  return (0, import_store.derived)(result, (r) => __spreadValues({
    queryKey
  }, r));
...
function useModelMutation(model, method, url, modelMeta, options, fetch2, checkReadBack) {
  ...
  return (0, import_svelte_query.createMutation)(finalOptions);
}
